...
public class LinkController {
    ...
    public String reqParam(@RequestParam("name") String name, @RequestParam("age") int age, Model model) {
    ...
    public String pathVariable(@PathVariable("name") String name, @PathVariable("age") int age, Model model) {
        model.addAttribute("name", name);
        model.addAttribute("age", age);
    ...
    // /hello/장원영?age=21
    public String pathAndQuery(@PathVariable("name") String name, @RequestParam("age") int age, Model model) {
        model.addAttribute("name", name);
        model.addAttribute("age", age);
        model.addAttribute("title", "Path And Query : ");
        return "/link/resultView";
    }
}
